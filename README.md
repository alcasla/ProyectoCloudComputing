...
La lista de hitos se describe a continuación:
  ...
  * Descripción inicial: incremento progresivo durante todo el proyecto, contando con descripción del proyecto, herramientas utilizadas, y demás instancias típicas y necesarias de una documentación.
  * Definición de estructura: 
  * Documentación incremento: 
